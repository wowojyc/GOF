...
public class Fail extends Action {
    ...
    public void getManConclusion(Man man) {
        ...
        System.out.println(man.getClass().getName() + this.getClass().getName() + "时，闷头喝酒，谁也不用劝");
    }
    ...
    public void getWomenConclusion(Woman woman) {
        // TODO Auto-generated method stub
        System.out.println(woman.getClass().getName() + this.getClass().getName() + "时，眼泪汪汪，谁也劝不了");
    }
